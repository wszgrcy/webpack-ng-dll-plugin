            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                        ...
                        styleLoading = Promise.all(config.stylesheets.map(function (item) {
                    ...
                    case 1:
                        _a.trys.push([1, 3, , 4]);
                        return [4, styleLoading];
                    case 2:
                        _a.sent();
                        return [2, window.loadRemoteModule(config.main, config.mainName)];
                    case 3:
                        error_1 = _a.sent();
                        throw error_1;
                    case 4: return [2];
